...
export default function About() {
  ...
  return (
    <div className='container' style={Style}>
        <h1 className="font-family">About US</h1>
  ...
  <div className="accordion-item">
    <h2 className="accordion-header" id="panelsStayOpen-headingTwo">
      <button className="accordion-button collapsed" type="button" style={Style} data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
        Accordion Item #2
      </button>
    </h2>
...
<div className="mt-3">
<button className="btn btn-dark text-light" onClick={toggleStyle}>{btntext}</button>
    </div>
    </div>
  )
}
